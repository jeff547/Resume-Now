...
const LoginForm = () => {
  ...
  return (
    <Card>
      <form className="flex min-w-[400px] flex-col items-start gap-6 px-8 py-6">
        ...
        <button className="px-4.5 mt-4 w-full cursor-pointer rounded-xl border border-purple-400 bg-gradient-to-b from-[#551dd9] to-[#7d58cd] py-3 transition duration-700 hover:border-purple-300 hover:from-[#6322f9] hover:to-[#9b6dfd] hover:text-gray-200">
          {login ? "Login" : "Sign Up"}
        </button>
        <GoogleLogin
